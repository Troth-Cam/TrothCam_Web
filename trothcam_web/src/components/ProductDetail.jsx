    ...
    const fetchProductDetail = async () => {
      try {
        const response = await axios.get(
          `https://trothly.com/api/product-detail/${productId}`
        );
        ...
        <Col1>
          <ImgDiv>
            ...
            <InfoContainer1>
              ...
              <Text2token>
                {" "}
                {truncateText(detail.authorshipToken, 15)}
              </Text2token>
            </InfoContainer1>
          </ImgDiv>
        ...
        <Col2>
          ...
          <Detail3>
            ...
            <BuydetailContainer>
              ...
              <BuyerDetail1>
                {truncateText(detail.authorshipToken, 8)}
              </BuyerDetail1>
              <BuyerDetail2 marginLeft="0px">
                {detail.histories[0].price}
              </BuyerDetail2>
